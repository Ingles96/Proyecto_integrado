...
class dietas extends db{
  ...
  public function MostrarDietasVegetarianas(){
    $sql="SELECT *
          FROM dietas
          Where Categoria='Vegetariana'";
  ...
  public function MostrarDietasHipocaloricas(){
    $sql="SELECT *
          FROM dietas
          Where Categoria='Hipocaloricas'";
    return $mostrarNoticias=$this->realizarConsulta($sql);
    if ($mostrarNoticias=!false) {
      return true;
    }else {
  ...
  public function MostrarDietasHipercaloricas(){
    $sql="SELECT *
          FROM dietas
          Where Categoria='Hipercaloricas'";
    return $MostrarDietasHipercaloricas=$this->realizarConsulta($sql);
    if ($MostrarDietasHipercaloricas=!false) {
      return true;
    }else {
      return false;
    }
  }
  public function MostrarDietasProteicas(){
    $sql="SELECT *
          FROM dietas
          Where Categoria='Proteicas'";
  ...
  public function MostrarDietasOtrasDietas(){
    $sql="SELECT *
          FROM dietas
          Where Categoria='Otras dietas'";
    return $mostrarDietasProteicas=$this->realizarConsulta($sql);
    if ($mostrarDietasProteicas=!false) {
      return true;
    }else {
