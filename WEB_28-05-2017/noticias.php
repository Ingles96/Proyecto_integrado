...
<style media="screen">
  ...
  <body>
        ...
        if ($data['rol']=='admin') {
         ?>
         <a href="Panel_de_Control/index.php">ADMINISTRACION</a>
         <?php
        }
        }
        ?>
    ...
    <div id="content" class="content">
			...
			<table>
						...
						<?php
						$tablaNoticias=$noticias->MostrarNoticias();
						foreach ($tablaNoticias as $fila) {
					 ?>
					 <tr>
						 <th><?php echo $fila['Titulo']; ?></th>
						 <th><img width="200px;" height="100px;" src="IMAGENES/slider1.jpg" width="250" height="200" style="margin-right:15px"> </th>
						 <th id="pequeño"><?php echo $fila['Descripcion']; ?> </th>
					</tr>
					 <?php
						}
						 ?>
